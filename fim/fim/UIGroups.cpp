...
#ifdef mydebug
	pListElement = static_cast<CListContainerElementUI*>(m_dlgBuilder.Create(_T("E:\\code\\duilib\\duilib\\r387\\fim\\Release\\images\\group_list_item.xml"), (UINT)0, NULL, &paint_manager_));
#else
	pListElement = static_cast<CListContainerElementUI*>(m_dlgBuilder.Create(_T("./images/group_list_item.xml"), (UINT)0, NULL, &paint_manager_));
#endif
