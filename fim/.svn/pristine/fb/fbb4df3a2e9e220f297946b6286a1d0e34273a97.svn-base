...
ColorSkinWindow::ColorSkinWindow(CMainFrame* main_frame, RECT rcParentWindow)
...
// 					for (;ii<5&&jj<8;ii++,jj++)
// 					{
// 						main_frame_->SetBkColor(Colors[ii][jj]);
// 					}
...
{
	return CDuiString(CPaintManagerUI::GetInstancePath()) + _T("images\\");
}
