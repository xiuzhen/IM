...
CFriendsUI::CFriendsUI(CPaintManagerUI& paint_manager)
	...
	, delay_number_(0)
	, delay_left_(0)
	, level_expand_image_(_T("<i ./images/list_icon_b.png>"))
	, level_collapse_image_(_T("<i ./images/list_icon_a.png>"))
...
#ifdef mydebug
	pListElement = static_cast<CListContainerElementUI*>(m_dlgBuilder.Create(_T("E:\\code\\duilib\\duilib\\r387\\fim\\Release\\images\\friend_list_item.xml"), (UINT)0, NULL, &paint_manager_));
#else
	pListElement = static_cast<CListContainerElementUI*>(m_dlgBuilder.Create(_T("./images/friend_list_item.xml"), (UINT)0, NULL, &paint_manager_));
#endif
            }
    else {
